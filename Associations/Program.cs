...
namespace Associations
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //workLogEntries.Add(new WorkLogEntry(new DateTime(1, 2, 4), "Дмитрий Медведев", new TimeSpan(0,4,0,0),"Работы была выполнена без трудностей"));
            batch.Add(new Batch(12345, new DateTime(1, 2, 3)));
            products[0].AddWorkLongEntry(new WorkLogEntry(new DateTime(1, 2, 4), "Дмитрий Медведев",
                new TimeSpan(0, 4, 0, 0), "Работы была выполнена без трудностей"));
            batch[0].AddProduct(new Product(1, new DateTime(1, 2, 3), false,productDescription[0]));
            //batch[0].AddProduct(new Product(2, new DateTime(1, 2, 3), false,productDescription[0]));
            //batch[0].AddProduct(new Product(3, new DateTime(1, 2, 3), true,productDescription[0])); 
            //batch[0].AddProduct(new Product(4, new DateTime(1, 2, 3), false,productDescription[0]));
